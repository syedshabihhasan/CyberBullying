...
def main():
    ...
    pid_dict = all_data[3]
    reciprocity_info = individual_reciprocity_analysis(labelled_data, pid_dict['participants'], location_to_store)
    hlp.dumpvariable([reciprocity_info, labelled_data, pid_dict], 'reciprocity_info.dict', location_to_store)
    print 'tadaa!'
